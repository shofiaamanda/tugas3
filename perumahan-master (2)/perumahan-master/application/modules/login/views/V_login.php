            ...
            <div class="row">
                <div class="col-sm-7 col-sm-push-5 col-md-8 col-md-push-4">
                    <div class="text-desclaimer">
                        ...
                        <a href="#" class="text-info">Anda butuh bantuan kami siap membantu.</a>
                    </div>
                </div>
                <form action="<?= base_url('login'); ?>" method="post">
                    <div class="col-sm-5 col-sm-pull-7 col-md-4 col-md-pull-8">
                        <div class="box">
                            ...
                            <div class="field">
                                <input type="password" placeholder="Kata Sandi" name="password" class="form-control" id="password">
                                <i class="fa fa-ellipsis-h"></i>
                            </div>
                            <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                            <div class="field footer-form text-right">
                                <span class="remember"><a href="<?= base_url('registrasi'); ?>" class="text-info">Anda belum punya akun?</a></span>
                                <button class="btn btn-default button-form" type="submit">Masuk</button>
                            </div>
                        </div>
                    </div>
                </form>
